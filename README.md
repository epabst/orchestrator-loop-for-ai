...
- **Configurable Agents:** Map different SDLC states to different AI agents (defaulting to Gemini).
...
- AI Agent CLI (e.g., `kiro-cli`) installed and configured.
...
Maps states to agent names.

```yaml
agents:
  default: gemini
state_agents:
  ai-design: design-specialist
```
